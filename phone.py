...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\nanda\Downloads\images-20240812T162628Z-001\p1.png"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\nanda\Downloads\images-20240812T162628Z-001\ph.jpg"),width=600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\nanda\Downloads\images-20240812T162628Z-001\p2.png"),width= 600)
